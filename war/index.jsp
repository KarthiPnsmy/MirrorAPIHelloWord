...
<%@ page import="com.titut.helloworld.MirrorClient" %>
<%@ page import="com.titut.helloworld.WebUtil" %>
...
<%@ page import="com.titut.helloworld.MainServlet" %>
...
<!doctype html>
<%
  String userId = com.titut.helloworld.AuthUtil.getUserId(request);
  String appBaseUrl = WebUtil.buildUrl(request, "/");

  Credential credential = com.titut.helloworld.AuthUtil.getCredential(userId);
